...
//        super.start();
    ...
    public void initialize() {
        ...
        if (settings.getBoolean("DebugMode") == true) {
            getStateManager().attach(new DebugState());
        }
...
////////////////////Initialize Director Variables
        ...
        stateManager.attach(new SpectreApplicationState());
        //Call Game Code
        SpectreApp();
    }
    ...
    /**
     * DO NOT USE.<br> MADE ONLY TO ACCOMMODATE
     * {@link SpectreApplicationState SpectreApplicationState}
     *
     * @return playerList HashMap<String, AnimData>
     */
    public HashMap<String, AnimData> getAnimationList() {
     ...
     * {@link SpectreApplicationState SpectreApplicationState}
     *
     * @return playerList HashMap<String, EntityId>
     */
    public HashMap<String, EntityId> getPlayerList() {
        return playerList;
    }
}
